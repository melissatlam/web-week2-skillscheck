...
var myName = "melissa"; // Code here

//////////////////PROBLEM 2////////////////////

// Create a variable called 'faveNum' with a value that is your favorite number.

var faveNum = 21; //Code here
...
//If it is, return a true boolean. If 'x' does not equal true, return a false boolean.
...
// Create a function called 'oddChecker' that takes in one parameter, 'num'. Your function should check to see if the parameter is even or odd.
...
// Create a function called 'iLove' that takes in two string parameters, 'name' and 'love'. Have the function take the two parameters and
//return a string that says "NAMEPARAM loves LOVEPARAM" with the appropriate parameters in the string. e.g. "Joseph loves music"
...
const middleNums = [numbers[1], numbers[2], numbers[3]];
...
//The value of the firstName key should be your name as a string. The value of the property state should be your current state
//or providence of residence as a string. The value of age should be your age as a number. greeter should be a method that returns the string 'Hello!
//My name is NAMEVALUE and I live in STATEVALUE' with the corresponding values.
...
//create a new array called 'answers'. Then, loop over the passed in arr parameter, and check to see if the number in the array is GREATER
//than 100. If it is, push 'big' as a string to the answers array. If the number is LESS than or EQUAL to 100, push 'small' as a string to the
// answers array. Return the answers array inside of the function.
...
var filtered = myNumbers.filter(x => x > 100); // Code Here
...
var total = myNumbers.reduce((a, b) => a + b); // Code Here
...
// var myNumbersIndex = myNumbers.forEach((function(element, index, arr)
...
let forTheLoveOfGeorge = notGeorge.map(function(element, index, arr) {
  return "George";
...
let totallyAwesome = people.reduce(function(total, element, index) {
  return total + people.awesomenessLevel;
});
